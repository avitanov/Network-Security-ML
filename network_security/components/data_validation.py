...
#from network_security.entity.artifact_entity 
...
class DataValidation:
    ...
    def validate_numerical_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"All {len(schema_numerical_columns)} numerical columns exist in DataFrame")
            return True
        except Exception as e:
            raise CustomException(e, sys)
    ...
    def initiate_data_validation(self)->DataIngestionArtifact:
        try:
            ...
            if not status:
                error_message=f"Train dataframe is missing numerical columns.\n"
