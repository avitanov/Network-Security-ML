...
class TrainingPipeline:
    ...
    ## sending local dir to S3 bucket
    def sync_artifact_dir_to_aws_s3(self):
        try:
    ...
    ## sending local final_model dir to S3 bucket
    def sync_saved_model_dir_to_aws_s3(self):
        try:
    ...
    def run_pipeline(self):
        try:
            ...
            self.sync_artifact_dir_to_aws_s3()
            self.sync_saved_model_dir_to_aws_s3()
